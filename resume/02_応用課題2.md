...
Content-Type: text/html;
 ...
 <p><a href="http://localhost:3000/users/confirmation?confirmation_token=rKNu3drinEgfNvvVkUjg">Confirm my account</a></p>
```
...
これで、 http://localhost:3000/letter_opener にて、送信されたメールが確認できるようになります。
